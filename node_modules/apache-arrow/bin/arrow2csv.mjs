...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const source of sources) {
        ...
        try {
            for (var _d = true, _e = (e_1 = void 0, __asyncValues(recordBatchReaders(source))), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                _c = _f.value;
                _d = false;
                try {
                    reader = _c;
...
function recordBatchReaders(createSourceStream) {
    return __asyncGenerator(this, arguments, function* recordBatchReaders_1() {
        ...
        try {
            try {
                for (var _g = true, _h = __asyncValues(RecordBatchReader.readAll(stream)), _j; _j = yield __await(_h.next()), _a = _j.done, !_a;) {
                    _c = _j.value;
                    _g = false;
                    try {
                        reader = _c;
        ...
        if (!readers) {
            ...
            try {
                try {
                    for (var _l = true, _m = __asyncValues(RecordBatchReader.readAll(bignumJSONParse(yield __await(json.toString())))), _o; _o = yield __await(_m.next()), _d = _o.done, !_d;) {
                        _f = _o.value;
                        _l = false;
                        try {
                            reader = _f;
