...
class environment_vizrec:
    def __init__(self):
        ...
        """
        self.user_list_movies_p1 = np.sort(glob.glob("data/zeng/processed_interactions_p1/*"))
        self.user_location_movies_p1 = "data/zeng/processed_interactions_p1/"
        self.user_list_movies_p2 = np.sort(glob.glob("data/zeng/processed_interactions_p2/*"))
        self.user_location_movies_p2 = "data/zeng/processed_interactions_p2/"
        self.user_list_movies_p3 = np.sort(glob.glob("data/zeng/processed_interactions_p3/*"))
        self.user_location_movies_p3 = "data/zeng/processed_interactions_p3/"
        self.user_list_movies_p4 = np.sort(glob.glob("data/zeng/processed_interactions_p4/*"))
        self.user_location_movies_p4 = "data/zeng/processed_interactions_p4/"
        self.user_list_birdstrikes_p1 = np.sort(glob.glob("data/zeng/birdstrikes_processed_interactions_p1/*"))
        self.user_location_birdstrikes_p1 = "data/zeng/birdstrikes_processed_interactions_p1/"
        self.user_list_birdstrikes_p2 = np.sort(glob.glob("data/zeng/birdstrikes_processed_interactions_p2/*"))
        self.user_location_birdstrikes_p2 = "data/zeng/birdstrikes_processed_interactions_p2/"
        self.user_list_birdstrikes_p3 = np.sort(glob.glob("data/zeng/birdstrikes_processed_interactions_p3/*"))
        self.user_location_birdstrikes_p3 = "data/zeng/birdstrikes_processed_interactions_p3/"
        self.user_list_birdstrikes_p4 = np.sort(glob.glob("data/zeng/birdstrikes_processed_interactions_p4/*"))
