...
function displayTask() {
  taskContent.innerHTML =
    "<div><b>Question:</b> The current question would be described here. <br> Example: Which origin has the most number of records? <br>Please <b>enter your answer</b> and also <b>bookmark charts</b> you think that could answer the question. <br><br><label>Your answer:</label> &nbsp;&nbsp; <input type='text' id='t-answer'><br><br></div>";
...
function goStudy() {
  ...
  if (status === "pilot") {
    ...
    sendUserInfo(inputText.toLowerCase(), status);
  }
}
